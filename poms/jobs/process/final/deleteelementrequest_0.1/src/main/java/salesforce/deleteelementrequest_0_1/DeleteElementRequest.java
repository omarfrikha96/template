...
package salesforce.deleteelementrequest_0_1;
...
/**
 * Job: DeleteElementRequest Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class DeleteElementRequest implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "DeleteElementRequest.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(DeleteElementRequest.class);
	...
	private final String jobName = "DeleteElementRequest";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					DeleteElementRequest.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(DeleteElementRequest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final DeleteElementRequest job;

		public RestServiceProviderImpl4TalendJob(DeleteElementRequest job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap,
				DeleteElementRequest job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(DeleteElementRequest job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = DeleteElementRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/deleteelementrequest_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = DeleteElementRequest.class.getClassLoader()
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		final static byte[] commonByteArrayLock_SALESFORCE_DeleteElementRequest = new byte[0];
		static byte[] commonByteArray_SALESFORCE_DeleteElementRequest = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_DeleteElementRequest.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_DeleteElementRequest.length == 0) {
						commonByteArray_SALESFORCE_DeleteElementRequest = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_DeleteElementRequest = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_DeleteElementRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_DeleteElementRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_DeleteElementRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_DeleteElementRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_DeleteElementRequest) {
...
// # Filter conditions 
							...
							row6.message != null
								...
								out1 = out1_tmp;
								log.debug("tMap_3 - Outputting the record " + count_out1_tMap_3
...
// ###############################      
				log.debug("tMap_3 - Written records count in the table 'out1': " + count_out1_tMap_3 + ".");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:m7wiFgWdz0nHesuFHHAUwpy+PRBFib/CmEOv+Puv8G4=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:TTRbNNWP2lV9zE+zYbwhzH0p3FUDl49M821yd6aCQ0A=");
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFixedFlowInput_4 = 0; i_tFixedFlowInput_4 < 1; i_tFixedFlowInput_4++) {
					...
					if (null == outputStream_tRESTResponse_1 && responseAlreadySent_tRESTResponse_1) {
						...
						restProviderResponse_tRESTResponse_1 = row4.body;
...
// ###############################
// # Lookup's keys initialization
				int count_error_map_out_tMap_2 = 0;
...
// Start of branch "body"
						if (body != null) {
							...
							if (null == outputStream_tRESTResponse_2 && responseAlreadySent_tRESTResponse_2) {
								...
								Integer restProviderStatusCode_tRESTResponse_2 = (Integer) globalMap.get("httpCode");

								Object restProviderResponse_tRESTResponse_2 = null;
								restProviderResponse_tRESTResponse_2 = body.body;
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_1 - inputs:(row5,row2) outputs:(error_map_out)
						...
						class BytesLimit65535_tSetGlobalVar_1 {
							public void limitLog4jByte() throws Exception {
								...
								log4jParamters_tSetGlobalVar_1.append("VARIABLES" + " = " + "[{VALUE="
										...
										+ ("\"code\"") + "}, {VALUE="
										+ ("TokenValidatorService.isBlank(header.correlationId) ? StringHandling.SUBSTR((java.util.UUID.randomUUID()).toString(), 10, 14) : header.correlationId")
										+ ", KEY=" + ("\"s_correlationId\"") + "}]");
...
// Start of branch "header"
					if (header != null) {
						...
						globalMap.put("s_correlationId",
								TokenValidatorService.isBlank(header.correlationId)
	...
	public static void main(String[] args) {
		final DeleteElementRequest DeleteElementRequestClass = new DeleteElementRequest();

		int exitCode = DeleteElementRequestClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'DeleteElementRequest' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'DeleteElementRequest' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = DeleteElementRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/deleteelementrequest_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = DeleteElementRequest.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : DeleteElementRequest");
		}
...
/************************************************************************************************
 * 293419 characters generated by Talend Open Studio for ESB on the 14 août 2024
 * à 9:50:22 AM CET
 ************************************************************************************************/