...
package salesforce.getalltrestclient_0_1;
...
/**
 * Job: getAllTrestClient Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class getAllTrestClient implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "getAllTrestClient.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(getAllTrestClient.class);
	...
	private final String jobName = "getAllTrestClient";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					getAllTrestClient.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(getAllTrestClient.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final getAllTrestClient job;

		public RestServiceProviderImpl4TalendJob(getAllTrestClient job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap,
				getAllTrestClient job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(getAllTrestClient job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = getAllTrestClient.class.getClassLoader()
					.getResourceAsStream("salesforce/getalltrestclient_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = getAllTrestClient.class.getClassLoader()
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		final static byte[] commonByteArrayLock_SALESFORCE_getAllTrestClient = new byte[0];
		static byte[] commonByteArray_SALESFORCE_getAllTrestClient = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_getAllTrestClient.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_getAllTrestClient.length == 0) {
						commonByteArray_SALESFORCE_getAllTrestClient = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_getAllTrestClient = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_getAllTrestClient, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_getAllTrestClient, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_getAllTrestClient, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_getAllTrestClient, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_getAllTrestClient) {
					...
					class BytesLimit65535_tExtractJSONFields_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tExtractJSONFields_1.append("MAPPING_4_JSONPATH" + " = " + "[{QUERY="
									...
									+ ", SCHEMA_COLUMN=" + ("name") + "}, {QUERY=" + ("\"status\"") + ", SCHEMA_COLUMN="
									+ ("status") + "}, {QUERY=" + ("\"category.id\"") + ", SCHEMA_COLUMN=" + ("id_")
									+ "}, {QUERY=" + ("\"category.name\"") + ", SCHEMA_COLUMN=" + ("name_") + "}]");
							log4jParamters_tExtractJSONFields_1.append(" | ");
							...
							if (!isStructError_tExtractJSONFields_1) {
								...
								try {
									...
									try {
										...
										row2.status = value_tExtractJSONFields_1 == null ?
									...
									try {
										...
										row2.name_ = value_tExtractJSONFields_1 == null ?
...
// Start of branch "body"
								if (body != null) {
									...
									if (null == outputStream_tRESTResponse_1 && responseAlreadySent_tRESTResponse_1) {
										...
										restProviderResponse_tRESTResponse_1 = body.body;
					...
					if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
						...
						if (matchedFlow_tRESTRequest_1.equals("header")) {
							...
							if (params_tRESTRequest_1.containsKey("PATH:id:id_String")) {
								...
								header.id = (String) params_tRESTRequest_1.get("PATH:id:id_String");
...
// Start of branch "header"
	...
	public static void main(String[] args) {
		final getAllTrestClient getAllTrestClientClass = new getAllTrestClient();

		int exitCode = getAllTrestClientClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'getAllTrestClient' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'getAllTrestClient' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = getAllTrestClient.class.getClassLoader()
					.getResourceAsStream("salesforce/getalltrestclient_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = getAllTrestClient.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : getAllTrestClient");
		}
...
/************************************************************************************************
 * 217171 characters generated by Talend Open Studio for ESB on the 16 août 2024
 * à 10:14:46 AM CET
 ************************************************************************************************/