...
package salesforce.updatedb_0_1;
 ...
 * @status
 */
public class UpdateDb implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "UpdateDb.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager.getLogger(UpdateDb.class);
	...
	private final String jobName = "UpdateDb";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(UpdateDb.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final UpdateDb job;

		public RestServiceProviderImpl4TalendJob(UpdateDb job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, UpdateDb job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(UpdateDb job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = UpdateDb.class.getClassLoader()
					.getResourceAsStream("salesforce/updatedb_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = UpdateDb.class.getClassLoader()
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		final static byte[] commonByteArrayLock_SALESFORCE_UpdateDb = new byte[0];
		static byte[] commonByteArray_SALESFORCE_UpdateDb = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_UpdateDb.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_UpdateDb.length == 0) {
						commonByteArray_SALESFORCE_UpdateDb = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_UpdateDb = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_UpdateDb, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_UpdateDb, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_UpdateDb, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_UpdateDb, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_UpdateDb) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:9qzjDQ8n8m2Hz463AWZ8ziIv3efKagmx9sngCFVy6+w=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:oBpegDLSJsQ/EVARfPRQRBuRsMcI3pfjFBRp2bq7m8Y=");
...
//the aggregate variable
				...
				int count_updatedProduct_tXMLMap_1_TXMLMAP_OUT = 0;
...
// ###############################
				...
				for (int i_tFixedFlowInput_2 = 0; i_tFixedFlowInput_2 < 1; i_tFixedFlowInput_2++) {
					...
					absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[0] = "row1.body:/products/product/PRIX_VENTE_PRODUIT";
					relativePathMappings_tXMLMap_1_TXMLMAP_OUT[0] = "PRIX_VENTE_PRODUIT";

					absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[1] = "row1.body:/products/product/NOM_PRODUIT";
					relativePathMappings_tXMLMap_1_TXMLMAP_OUT[1] = "NOM_PRODUIT";

					absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[2] = "row1.body:/products/product/CD_PRODUIT";
					relativePathMappings_tXMLMap_1_TXMLMAP_OUT[2] = "CD_PRODUIT";

					absolutePathMappings_tXMLMap_1_TXMLMAP_OUT[3] = "row1.body:/products/product/PRIX_ACHAT_PRODUIT";
					relativePathMappings_tXMLMap_1_TXMLMAP_OUT[3] = "PRIX_ACHAT_PRODUIT";
...
// # Output table : 'updatedProduct'
							count_updatedProduct_tXMLMap_1_TXMLMAP_OUT++;

							updatedProduct_tmp = new updatedProductStruct();
							updatedProduct_tmp.CD_PRODUIT = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
									.get_String("row1.body:/products/product/CD_PRODUIT");
							updatedProduct_tmp.NOM_PRODUIT = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
									.get_String("row1.body:/products/product/NOM_PRODUIT");
							updatedProduct_tmp.PRIX_ACHAT_PRODUIT = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
									.get_BigDecimal("row1.body:/products/product/PRIX_ACHAT_PRODUIT");
							updatedProduct_tmp.PRIX_VENTE_PRODUIT = treeNodeAPI_tXMLMap_1_TXMLMAP_OUT
									.get_BigDecimal("row1.body:/products/product/PRIX_VENTE_PRODUIT");
							allOutsForAggregate_tXMLMap_1.add(updatedProduct_tmp);

							log.debug("tXMLMap_1 - Outputting the record " + count_updatedProduct_tXMLMap_1_TXMLMAP_OUT
...
// ###############################
				...
				log.debug("tXMLMap_1 - Written records count in the table 'updatedProduct': "
						+ count_updatedProduct_tXMLMap_1_TXMLMAP_OUT + ".");
				...
				for (Object row_out_tXMLMap_1_TXMLMAP_IN : outs_tXMLMap_1) {// TD512
					...
					if (row_out_tXMLMap_1_TXMLMAP_IN != null
							&& row_out_tXMLMap_1_TXMLMAP_IN instanceof updatedProductStruct) {
						updatedProduct = (updatedProductStruct) row_out_tXMLMap_1_TXMLMAP_IN;
					}
...
// Start of branch "updatedProduct"
					if (updatedProduct != null) {
						...
						if (updatedProduct.NOM_PRODUIT == null) {
							...
							pstmt_tDBOutput_1.setString(1, updatedProduct.NOM_PRODUIT);
						}

						pstmt_tDBOutput_1.setBigDecimal(2, updatedProduct.PRIX_ACHAT_PRODUIT);

						pstmt_tDBOutput_1.setBigDecimal(3, updatedProduct.PRIX_VENTE_PRODUIT);

						if (updatedProduct.CD_PRODUIT == null) {
							pstmt_tDBOutput_1.setNull(4 + count_tDBOutput_1, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(4 + count_tDBOutput_1, updatedProduct.CD_PRODUIT);
						}
				...
				if (((Integer) globalMap.get("tDBOutput_1_NB_LINE_UPDATED")) > 0) {
				...
				if (((String) globalMap.get("tDBOutput_1_ERROR_MESSAGE")).contains("null value in column")) {
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tSetGlobalVar_3 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tSetGlobalVar_3.append("VARIABLES" + " = " + "[{VALUE=" + ("400") + ", KEY="
...
// Start of branch "header"
	...
	public static void main(String[] args) {
		final UpdateDb UpdateDbClass = new UpdateDb();

		int exitCode = UpdateDbClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'UpdateDb' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'UpdateDb' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = UpdateDb.class.getClassLoader()
					.getResourceAsStream("salesforce/updatedb_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = UpdateDb.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : UpdateDb");
		}
...
/************************************************************************************************
 * 319914 characters generated by Talend Open Studio for ESB on the 16 août 2024
 * à 8:38:38 AM CET
 ************************************************************************************************/