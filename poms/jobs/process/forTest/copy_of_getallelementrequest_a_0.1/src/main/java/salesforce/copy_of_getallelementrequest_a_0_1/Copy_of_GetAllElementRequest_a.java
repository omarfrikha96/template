...
package salesforce.copy_of_getallelementrequest_a_0_1;
...
import routines.TokenValidatorTest;
...
/**
 * Job: Copy_of_GetAllElementRequest_a Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_GetAllElementRequest_a implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Copy_of_GetAllElementRequest_a.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Copy_of_GetAllElementRequest_a.class);
	...
	private final String jobName = "Copy_of_GetAllElementRequest_a";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_GetAllElementRequest_a.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_GetAllElementRequest_a.this,
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final Copy_of_GetAllElementRequest_a job;

		public RestServiceProviderImpl4TalendJob(Copy_of_GetAllElementRequest_a job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap,
				Copy_of_GetAllElementRequest_a job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(Copy_of_GetAllElementRequest_a job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = Copy_of_GetAllElementRequest_a.class.getClassLoader().getResourceAsStream(
					"salesforce/copy_of_getallelementrequest_a_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = Copy_of_GetAllElementRequest_a.class.getClassLoader()
	...
	public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
		final static byte[] commonByteArrayLock_SALESFORCE_Copy_of_GetAllElementRequest_a = new byte[0];
		static byte[] commonByteArray_SALESFORCE_Copy_of_GetAllElementRequest_a = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_Copy_of_GetAllElementRequest_a.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_Copy_of_GetAllElementRequest_a.length == 0) {
						commonByteArray_SALESFORCE_Copy_of_GetAllElementRequest_a = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_Copy_of_GetAllElementRequest_a = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_Copy_of_GetAllElementRequest_a, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_Copy_of_GetAllElementRequest_a, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_Copy_of_GetAllElementRequest_a, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_Copy_of_GetAllElementRequest_a, 0, length,
						utf8Charset);
			}
			return strReturn;
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_Copy_of_GetAllElementRequest_a) {
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tFlowToIterate_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFlowToIterate_2.append("MAP" + " = " + "[{VALUE=" + ("httpCode") + ", KEY="
									+ ("\"i_httpCode\"") + "}, {VALUE=" + ("error_message") + ", KEY="
									+ ("\"error_message\"") + "}]");
							log4jParamters_tFlowToIterate_2.append(" | ");
							if (log.isDebugEnabled())
...
// # Filter conditions 
							...
							!row2.message.contains("Invalid JWS header")

							) {
								count_copyOfout1_tMap_2++;

								copyOfout1_tmp.httpCode = 500;
								copyOfout1_tmp.error_message = Var.var1;
...
// # Filter conditions 
							...
							row2.message.contains("Invalid JWS header")
								...
								out2_tmp.httpCode = 401;
								out2_tmp.error_message = Var.var2;
								out2 = out2_tmp;
...
// Start of branch "copyOfout1"
						if (copyOfout1 != null) {
							...
							row3.httpCode = copyOfout1.httpCode;
							row3.error_message = copyOfout1.error_message;
...
// Start of branch "out2"
						if (out2 != null) {
							...
							row5.httpCode = out2.httpCode;
							row5.error_message = out2.error_message;
							...
							if (log.isTraceEnabled())
								log.trace("tFlowToIterate_2 - " + ("Set global var, key=") + ("i_httpCode")
										+ (", value=") + (row5.httpCode) + ("."));
							globalMap.put("i_httpCode", row5.httpCode);
							if (log.isTraceEnabled())
								log.trace("tFlowToIterate_2 - " + ("Set global var, key=") + ("error_message")
										+ (", value=") + (row5.error_message) + ("."));
							globalMap.put("error_message", row5.error_message);
							...
							for (int i_tFixedFlowInput_2 = 0; i_tFixedFlowInput_2 < 1; i_tFixedFlowInput_2++) {
								...
								row6.body = (String) globalMap.get("error_message");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:HnsuVAoF7ic3bvoIG9lvkuFA6MfEY3w68lJvN8N3pK0=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:XWkWabwOfhnAdiVlQ8pZX3RmK3TGeANxMvv493bKwzE=");
	...
	public void tSetGlobalVar_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tSetGlobalVar_4 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tSetGlobalVar_4.append("VARIABLES" + " = " + "[{VALUE=" + ("404") + ", KEY="
									+ ("\"httpCode\"") + "}, {VALUE=" + ("\"DataBase is Empty \"") + ", KEY="
									+ ("\"cause_message\"") + "}]");
				...
				globalMap.put("cause_message", "DataBase is Empty ");
						...
						class BytesLimit65535_tSetGlobalVar_1 {
							public void limitLog4jByte() throws Exception {
								...
								log4jParamters_tSetGlobalVar_1.append("VARIABLES" + " = " + "[{VALUE="
										+ ("((TokenValidatorTest)globalMap.get(\"tokenValidatorTest\")).validateToken(header.Authorization,globalMap)")
										+ ", KEY=" + ("\"is_valid_token\"") + "}, {VALUE=" + ("0") + ", KEY="
										+ ("\"i_stepSequence\"") + "}, {VALUE="
										+ ("TokenValidatorTest.isBlank(header.correlationId) ? StringHandling.SUBSTR((java.util.UUID.randomUUID()).toString(), 10, 14) : header.correlationId")
										+ ", KEY=" + ("\"s_correlationId\"") + "}]");
...
// Start of branch "header"
					if (header != null) {
						...
						globalMap.put("is_valid_token", ((TokenValidatorTest) globalMap.get("tokenValidatorTest"))
								.validateToken(header.Authorization, globalMap));
						globalMap.put("i_stepSequence", 0);
						globalMap.put("s_correlationId",
								TokenValidatorTest.isBlank(header.correlationId)
	...
	public static void main(String[] args) {
		final Copy_of_GetAllElementRequest_a Copy_of_GetAllElementRequest_aClass = new Copy_of_GetAllElementRequest_a();

		int exitCode = Copy_of_GetAllElementRequest_aClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Copy_of_GetAllElementRequest_a' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Copy_of_GetAllElementRequest_a' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_GetAllElementRequest_a.class.getClassLoader().getResourceAsStream(
					"salesforce/copy_of_getallelementrequest_a_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_GetAllElementRequest_a.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_GetAllElementRequest_a");
		}
...
/************************************************************************************************
 * 245450 characters generated by Talend Open Studio for ESB on the 15 août 2024
 * à 12:05:15 PM CET
 ************************************************************************************************/