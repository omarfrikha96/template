...
package salesforce.copy_of_trestexp1_a_0_1;
...
/**
 * Job: Copy_of_trestExp1_a Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_trestExp1_a implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Copy_of_trestExp1_a.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Copy_of_trestExp1_a.class);
	...
	private final String jobName = "Copy_of_trestExp1_a";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_trestExp1_a.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_trestExp1_a.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final Copy_of_trestExp1_a job;

		public RestServiceProviderImpl4TalendJob(Copy_of_trestExp1_a job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap,
				Copy_of_trestExp1_a job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(Copy_of_trestExp1_a job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = Copy_of_trestExp1_a.class.getClassLoader()
					.getResourceAsStream("salesforce/copy_of_trestexp1_a_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = Copy_of_trestExp1_a.class.getClassLoader()
	...
	public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
		final static byte[] commonByteArrayLock_SALESFORCE_Copy_of_trestExp1_a = new byte[0];
		static byte[] commonByteArray_SALESFORCE_Copy_of_trestExp1_a = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_Copy_of_trestExp1_a.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_Copy_of_trestExp1_a.length == 0) {
						commonByteArray_SALESFORCE_Copy_of_trestExp1_a = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_Copy_of_trestExp1_a = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_Copy_of_trestExp1_a, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_Copy_of_trestExp1_a, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_Copy_of_trestExp1_a, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_Copy_of_trestExp1_a, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_Copy_of_trestExp1_a) {
...
// expected response body
				...
				try {
					...
					String url = "https://petstore3.swagger.io/api/v3/pet/5";
					// {baseUri}tRESTClient
...
// Start of branch "header"
	...
	public static void main(String[] args) {
		final Copy_of_trestExp1_a Copy_of_trestExp1_aClass = new Copy_of_trestExp1_a();

		int exitCode = Copy_of_trestExp1_aClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Copy_of_trestExp1_a' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Copy_of_trestExp1_a' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_trestExp1_a.class.getClassLoader()
					.getResourceAsStream("salesforce/copy_of_trestexp1_a_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_trestExp1_a.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Copy_of_trestExp1_a");
		}
...
/************************************************************************************************
 * 213729 characters generated by Talend Open Studio for ESB on the 15 août 2024
 * à 1:19:58 PM CET
 ************************************************************************************************/