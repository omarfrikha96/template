...
package salesforce.copy_of_getallrequest_c_0_1;
...
/**
 * Job: Copy_of_GetAllRequest_c Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_GetAllRequest_c implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Copy_of_GetAllRequest_c.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Copy_of_GetAllRequest_c.class);
	...
	private final String jobName = "Copy_of_GetAllRequest_c";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_GetAllRequest_c.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_GetAllRequest_c.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final Copy_of_GetAllRequest_c job;

		public RestServiceProviderImpl4TalendJob(Copy_of_GetAllRequest_c job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap,
				Copy_of_GetAllRequest_c job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(Copy_of_GetAllRequest_c job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = Copy_of_GetAllRequest_c.class.getClassLoader()
					.getResourceAsStream("salesforce/copy_of_getallrequest_c_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = Copy_of_GetAllRequest_c.class.getClassLoader()
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_SALESFORCE_Copy_of_GetAllRequest_c = new byte[0];
		static byte[] commonByteArray_SALESFORCE_Copy_of_GetAllRequest_c = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_Copy_of_GetAllRequest_c.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_Copy_of_GetAllRequest_c.length == 0) {
						commonByteArray_SALESFORCE_Copy_of_GetAllRequest_c = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_Copy_of_GetAllRequest_c = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_Copy_of_GetAllRequest_c, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_Copy_of_GetAllRequest_c, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_Copy_of_GetAllRequest_c, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_Copy_of_GetAllRequest_c, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_Copy_of_GetAllRequest_c) {
	...
	public void tLogCatcher_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "moment", "pid", "root_pid", "father_pid", "project", "job",
...
///////////////////////		
						...
						if (row2.moment != null) { //
							row_tLogRow_1[0] = FormatterUtils.format_Date(row2.moment, "yyyy-MM-dd HH:mm:ss");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:u9//Oey/9jCwEmAmxp1JVNmqnE0Eo6Esn4Ilii6pTdI=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:cnHZ+o5ENPHd33zf+eFHpmKiL81HYojNtHOmrdTc2gM=");
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (null == outputStream_tRESTResponse_2 && responseAlreadySent_tRESTResponse_2) {
					...
					if (null != row3.body) {
						restProviderResponse_tRESTResponse_2 = row3.body.getDocument();
					}
						...
						if (null != restProviderResponse_tRESTResponse_2) {
							...
							javax.ws.rs.ext.MessageBodyWriter messageBodyWriter_tRESTResponse_2 = messageBodyProviders_tRESTResponse_2
									.getMessageBodyWriter(responseBodyClass_tRESTResponse_2,
											responseBodyClass_tRESTResponse_2, null, responseMediaType_tRESTResponse_2);
							...
							messageBodyWriter_tRESTResponse_2.writeTo(restProviderResponse_tRESTResponse_2,
									...
									new java.lang.annotation.Annotation[] {}, responseMediaType_tRESTResponse_2, null,
...
// Start of branch "header"
	...
	public static void main(String[] args) {
		final Copy_of_GetAllRequest_c Copy_of_GetAllRequest_cClass = new Copy_of_GetAllRequest_c();

		int exitCode = Copy_of_GetAllRequest_cClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Copy_of_GetAllRequest_c' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Copy_of_GetAllRequest_c' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_GetAllRequest_c.class.getClassLoader().getResourceAsStream(
					"salesforce/copy_of_getallrequest_c_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_GetAllRequest_c.class.getClassLoader()
			...
			class ContextProcessing {
				private void processContext_0() {
					...
					context.setContextType("httpCode", "id_String");
					if (context.getStringValue("httpCode") == null) {
						context.httpCode = null;
					} else {
						context.httpCode = (String) context.getProperty("httpCode");
					}
				}
		...
		if (parentContextMap != null && !parentContextMap.isEmpty()) {
			...
			if (parentContextMap.containsKey("httpCode")) {
				context.httpCode = (String) parentContextMap.get("httpCode");
			}
		}
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_GetAllRequest_c");
		}
...
/************************************************************************************************
 * 190527 characters generated by Talend Open Studio for ESB on the 11 août 2024
 * à 12:36:37 PM CET
 ************************************************************************************************/