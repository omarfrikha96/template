...
package salesforce.getallrequest_0_1;
 ...
 * @status
 */
public class GetAllRequest implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "GetAllRequest.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(GetAllRequest.class);
	...
	private final String jobName = "GetAllRequest";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					GetAllRequest.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(GetAllRequest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final GetAllRequest job;

		public RestServiceProviderImpl4TalendJob(GetAllRequest job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, GetAllRequest job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(GetAllRequest job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = GetAllRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/getallrequest_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = GetAllRequest.class.getClassLoader()
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:SQfbCzlkSni1WEhEPftbI2c9+ZIPf43WvWlD8ZuoYRk=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:9iqcYco7XSLvn5pdtBo/yv2iW58LXq2G+QZx+4ZoVps=");
	...
	public static class ressssStruct implements routines.system.IPersistableRow<ressssStruct> {
		final static byte[] commonByteArrayLock_SALESFORCE_GetAllRequest = new byte[0];
		static byte[] commonByteArray_SALESFORCE_GetAllRequest = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_GetAllRequest) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_GetAllRequest.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_GetAllRequest.length == 0) {
						commonByteArray_SALESFORCE_GetAllRequest = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_GetAllRequest = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_GetAllRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_GetAllRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_GetAllRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_GetAllRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
...
// Start of branch "header"
	...
	public static void main(String[] args) {
		final GetAllRequest GetAllRequestClass = new GetAllRequest();

		int exitCode = GetAllRequestClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'GetAllRequest' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'GetAllRequest' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = GetAllRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/getallrequest_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = GetAllRequest.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : GetAllRequest");
		}
...
/************************************************************************************************
 * 192459 characters generated by Talend Open Studio for ESB on the 13 août 2024
 * à 4:20:03 PM CET
 ************************************************************************************************/