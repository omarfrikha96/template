...
package salesforce.deleterequest_0_1;
 ...
 * @status
 */
public class DeleteRequest implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "DeleteRequest.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(DeleteRequest.class);
	...
	private final String jobName = "DeleteRequest";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					DeleteRequest.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(DeleteRequest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final DeleteRequest job;

		public RestServiceProviderImpl4TalendJob(DeleteRequest job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, DeleteRequest job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(DeleteRequest job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = DeleteRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/deleterequest_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = DeleteRequest.class.getClassLoader()
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:bdfA/ls4sLyeMqPZvc36B053Hk9vmuo0CLN/zKBbG/g=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:neBBr+IVN5w4AsMzX8AxFDYGIigRhu18Ap+On66cZXQ=");
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_SALESFORCE_DeleteRequest = new byte[0];
		static byte[] commonByteArray_SALESFORCE_DeleteRequest = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_DeleteRequest.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_DeleteRequest.length == 0) {
						commonByteArray_SALESFORCE_DeleteRequest = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_DeleteRequest = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_DeleteRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_DeleteRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_DeleteRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_DeleteRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_DeleteRequest) {
...
// Start of branch "header"
	...
	public static void main(String[] args) {
		final DeleteRequest DeleteRequestClass = new DeleteRequest();

		int exitCode = DeleteRequestClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'DeleteRequest' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'DeleteRequest' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = DeleteRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/deleterequest_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = DeleteRequest.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : DeleteRequest");
		}
...
/************************************************************************************************
 * 190108 characters generated by Talend Open Studio for ESB on the 7 août 2024
 * à 10:43:27 AM CET
 ************************************************************************************************/