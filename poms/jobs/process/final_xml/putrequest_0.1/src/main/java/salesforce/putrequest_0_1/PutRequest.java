...
package salesforce.putrequest_0_1;
 ...
 * @status
 */
public class PutRequest implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "PutRequest.log");
	}
	...
	private final String jobName = "PutRequest";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(PutRequest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final PutRequest job;

		public RestServiceProviderImpl4TalendJob(PutRequest job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, PutRequest job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(PutRequest job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = PutRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/putrequest_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = PutRequest.class.getClassLoader()
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:Zk0nnUqBsM7g2BRZglhFRGOMn4IxTOxzTBb2j5x1CJs=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:C43p/MNENuZcTBhhUINYG7IitygBRhwkUHlUd7eT2a4=");
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_SALESFORCE_PutRequest = new byte[0];
		static byte[] commonByteArray_SALESFORCE_PutRequest = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_PutRequest.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_PutRequest.length == 0) {
						commonByteArray_SALESFORCE_PutRequest = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_PutRequest = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_PutRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_PutRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_PutRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_PutRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_PutRequest) {
	...
	public static class updatedProductStruct implements routines.system.IPersistableRow<updatedProductStruct> {
		final static byte[] commonByteArrayLock_SALESFORCE_PutRequest = new byte[0];
		static byte[] commonByteArray_SALESFORCE_PutRequest = new byte[0];
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final updatedProductStruct other = (updatedProductStruct) obj;
		...
		public void copyDataTo(updatedProductStruct other) {
		...
		public void copyKeysDataTo(updatedProductStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(updatedProductStruct other) {
	...
	public void tFixedFlowInput_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				updatedProductStruct updatedProduct = new updatedProductStruct();
...
// # Outputs initialization
				updatedProductStruct updatedProduct_tmp = new updatedProductStruct();
				updatedProductStruct updatedProduct_save = null;
//the aggregate variable
				updatedProductStruct updatedProduct_aggregate = null;
				int count_updatedProduct_tXMLMap_4_TXMLMAP_OUT = 0;
...
// ###############################
				...
				for (int i_tFixedFlowInput_6 = 0; i_tFixedFlowInput_6 < 1; i_tFixedFlowInput_6++) {
					...
					row1.body = (Document) globalMap.get("body");
					...
					docToFlat_tXMLMap_4_TXMLMAP_OUT.setOriginalLoop("/products/product");
					...
					absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "row1.body:/products/product/PRIX_VENTE_PRODUIT";
					relativePathMappings_tXMLMap_4_TXMLMAP_OUT[0] = "PRIX_VENTE_PRODUIT";

					absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[1] = "row1.body:/products/product/NOM_PRODUIT";
					relativePathMappings_tXMLMap_4_TXMLMAP_OUT[1] = "NOM_PRODUIT";

					absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[2] = "row1.body:/products/product/CD_PRODUIT";
					relativePathMappings_tXMLMap_4_TXMLMAP_OUT[2] = "CD_PRODUIT";

					absolutePathMappings_tXMLMap_4_TXMLMAP_OUT[3] = "row1.body:/products/product/PRIX_ACHAT_PRODUIT";
					relativePathMappings_tXMLMap_4_TXMLMAP_OUT[3] = "PRIX_ACHAT_PRODUIT";
...
// # Output table : 'updatedProduct'
							count_updatedProduct_tXMLMap_4_TXMLMAP_OUT++;

							updatedProduct_tmp = new updatedProductStruct();
							updatedProduct_tmp.CD_PRODUIT = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT
									.get_String("row1.body:/products/product/CD_PRODUIT");
							updatedProduct_tmp.NOM_PRODUIT = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT
									.get_String("row1.body:/products/product/NOM_PRODUIT");
							updatedProduct_tmp.PRIX_ACHAT_PRODUIT = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT
									.get_BigDecimal("row1.body:/products/product/PRIX_ACHAT_PRODUIT");
							updatedProduct_tmp.PRIX_VENTE_PRODUIT = treeNodeAPI_tXMLMap_4_TXMLMAP_OUT
									.get_BigDecimal("row1.body:/products/product/PRIX_VENTE_PRODUIT");
							allOutsForAggregate_tXMLMap_4.add(updatedProduct_tmp);

							log.debug("tXMLMap_4 - Outputting the record " + count_updatedProduct_tXMLMap_4_TXMLMAP_OUT
									+ " of the output table 'updatedProduct'.");
...
// ###############################
				...
				log.debug("tXMLMap_4 - Written records count in the table 'updatedProduct': "
						+ count_updatedProduct_tXMLMap_4_TXMLMAP_OUT + ".");
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "updatedProduct");
				}
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_2 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_2.append(" | ");
							log4jParamters_tDBOutput_2.append("TABLE" + " = " + "\"Produit\"");
							log4jParamters_tDBOutput_2.append(" | ");
				...
				if (dbschema_tDBOutput_2 == null || dbschema_tDBOutput_2.trim().length() == 0) {
					tableName_tDBOutput_2 = ("Produit");
				} else {
					tableName_tDBOutput_2 = dbschema_tDBOutput_2 + "\".\"" + ("Produit");
				}
				...
				String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2
						+ "\" SET \"NOM_PRODUIT\" = ?,\"PRIX_ACHAT_PRODUIT\" = ?,\"PRIX_VENTE_PRODUIT\" = ? WHERE \"CD_PRODUIT\" = ?";
				...
				for (Object row_out_tXMLMap_4_TXMLMAP_IN : outs_tXMLMap_4) {// TD512
					...
					if (row_out_tXMLMap_4_TXMLMAP_IN != null
							&& row_out_tXMLMap_4_TXMLMAP_IN instanceof updatedProductStruct) {
						updatedProduct = (updatedProductStruct) row_out_tXMLMap_4_TXMLMAP_IN;
					}
					 ...
					 */
// Start of branch "updatedProduct"
					if (updatedProduct != null) {
						...
						if (log.isTraceEnabled()) {
							log.trace(
									"updatedProduct - " + (updatedProduct == null ? "" : updatedProduct.toLogString()));
						}

						whetherReject_tDBOutput_2 = false;
						if (updatedProduct.NOM_PRODUIT == null) {
							pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_2.setString(1, updatedProduct.NOM_PRODUIT);
						}

						pstmt_tDBOutput_2.setBigDecimal(2, updatedProduct.PRIX_ACHAT_PRODUIT);

						pstmt_tDBOutput_2.setBigDecimal(3, updatedProduct.PRIX_VENTE_PRODUIT);

						if (updatedProduct.CD_PRODUIT == null) {
							pstmt_tDBOutput_2.setNull(4 + count_tDBOutput_2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_2.setString(4 + count_tDBOutput_2, updatedProduct.CD_PRODUIT);
						}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "updatedProduct");
				}
				...
				if (((Integer) globalMap.get("tDBOutput_2_NB_LINE_UPDATED")) > 0) {
				...
				if (((Integer) globalMap.get("tDBOutput_2_NB_LINE_UPDATED")) == 0
						&& ((String) globalMap.get("tDBOutput_2_ERROR_MESSAGE")) == null) {
				...
				if (((String) globalMap.get("tDBOutput_2_ERROR_MESSAGE")) != null) {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFixedFlowInput_1 = 0; i_tFixedFlowInput_1 < 1; i_tFixedFlowInput_1++) {
					...
					if (null == outputStream_tRESTResponse_1 && responseAlreadySent_tRESTResponse_1) {
						...
						restProviderResponse_tRESTResponse_1 = row5.body;
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFixedFlowInput_5 = 0; i_tFixedFlowInput_5 < 1; i_tFixedFlowInput_5++) {
					...
					if (null == outputStream_tRESTResponse_5 && responseAlreadySent_tRESTResponse_5) {
						...
						Integer restProviderStatusCode_tRESTResponse_5 = 400;

						Object restProviderResponse_tRESTResponse_5 = null;
						restProviderResponse_tRESTResponse_5 = row6.body;
						...
						if (null == outputStream_tRESTResponse_5) {
							...
							if (!responseAlreadySent_tRESTResponse_5) {
								...
								messageContext_tRESTResponse_5.put(org.apache.cxf.message.Message.PROTOCOL_HEADERS,
								...
								if (null == responseContentType_tRESTResponse_5) {
									// this should not be needed, just in case. set it to the first value in the
									// sorted list returned from HttpHeaders
									responseMediaType_tRESTResponse_5 = messageContext_tRESTResponse_5.getHttpHeaders()
											.getAcceptableMediaTypes().get(0);
								} else {
							...
							if (null != restProviderResponse_tRESTResponse_5) {
								...
								messageBodyWriter_tRESTResponse_5.writeTo(restProviderResponse_tRESTResponse_5,
										...
										new java.lang.annotation.Annotation[] {}, responseMediaType_tRESTResponse_5,
										null, outputStream_tRESTResponse_5);
							}
							// initial variant
...
// Start of branch "header"
	...
	public static void main(String[] args) {
		final PutRequest PutRequestClass = new PutRequest();

		int exitCode = PutRequestClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'PutRequest' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'PutRequest' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = PutRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/putrequest_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = PutRequest.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : PutRequest");
		}
...
/************************************************************************************************
 * 231101 characters generated by Talend Open Studio for ESB on the 12 août 2024
 * à 9:57:01 AM CET
 ************************************************************************************************/