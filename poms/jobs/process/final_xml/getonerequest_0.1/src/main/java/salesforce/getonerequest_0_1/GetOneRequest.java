...
package salesforce.getonerequest_0_1;
 ...
 * @status
 */
public class GetOneRequest implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "GetOneRequest.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(GetOneRequest.class);
	...
	private final String jobName = "GetOneRequest";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					GetOneRequest.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(GetOneRequest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final GetOneRequest job;

		public RestServiceProviderImpl4TalendJob(GetOneRequest job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, GetOneRequest job) {
		...
		public javax.ws.rs.core.Response header(
				...
				@javax.ws.rs.PathParam("code") String code
			...
			request_tRESTRequest_1.put("PATTERN", "/product/{code}");
			...
			parameters_tRESTRequest_1.put("PATH:code:id_String", code);
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(GetOneRequest job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = GetOneRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/getonerequest_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = GetOneRequest.class.getClassLoader()
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:veNkf+CKeWi/32OrK7TEKEJNwPyw7aaw+ZYhtkmkZD8=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:OfLavKLMwqGHkIC6XS56Gxct7H9rGv53I9yEVyKmK2s=");
	...
	public static class oneProductStruct implements routines.system.IPersistableRow<oneProductStruct> {
		final static byte[] commonByteArrayLock_SALESFORCE_GetOneRequest = new byte[0];
		static byte[] commonByteArray_SALESFORCE_GetOneRequest = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_GetOneRequest) {
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_GetOneRequest.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_GetOneRequest.length == 0) {
						commonByteArray_SALESFORCE_GetOneRequest = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_GetOneRequest = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_GetOneRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_GetOneRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_GetOneRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_GetOneRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
					...
					class BytesLimit65535_tFilterRow_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tFilterRow_1.append("CONDITIONS" + " = " + "[{OPERATOR=" + ("==")
									+ ", RVALUE=" + ("((String)globalMap.get(\"code\"))") + ", INPUT_COLUMN="
									+ ("CD_PRODUIT") + ", FUNCTION=" + ("") + "}]");
							log4jParamters_tFilterRow_1.append(" | ");
					...
					while (rs_tDBInput_1.next()) {
						...
						ope_tFilterRow_1.matches(
								(row1.CD_PRODUIT == null ? false
										: row1.CD_PRODUIT.compareTo(((String) globalMap.get("code"))) == 0),
								"CD_PRODUIT.compareTo(((String)globalMap.get(\"code\"))) == 0 failed");
				...
				try {
						...
						class BytesLimit65535_tSetGlobalVar_1 {
							public void limitLog4jByte() throws Exception {
								...
								log4jParamters_tSetGlobalVar_1.append("VARIABLES" + " = " + "[{VALUE="
										...
										+ ("\"i_stepSequence\"") + "}, {VALUE=" + ("header.code") + ", KEY="
										+ ("\"code\"") + "}]");
					...
					if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
						...
						if (matchedFlow_tRESTRequest_1.equals("header")) {
							...
							if (params_tRESTRequest_1.containsKey("PATH:code:id_String")) {

								header.code = (String) params_tRESTRequest_1.get("PATH:code:id_String");
...
// Start of branch "header"
					if (header != null) {
						...
						globalMap.put("code", header.code);
	...
	public static void main(String[] args) {
		final GetOneRequest GetOneRequestClass = new GetOneRequest();

		int exitCode = GetOneRequestClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'GetOneRequest' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'GetOneRequest' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = GetOneRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/getonerequest_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = GetOneRequest.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : GetOneRequest");
		}
...
/************************************************************************************************
 * 207635 characters generated by Talend Open Studio for ESB on the 11 août 2024
 * à 12:57:23 PM CET
 ************************************************************************************************/