...
package salesforce.copy_of_ws_validate_token_0_1;
...
/**
 * Job: Copy_of_ws_VALIDATE_TOKEN Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_ws_VALIDATE_TOKEN implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Copy_of_ws_VALIDATE_TOKEN.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Copy_of_ws_VALIDATE_TOKEN.class);
	...
	private final String jobName = "Copy_of_ws_VALIDATE_TOKEN";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_ws_VALIDATE_TOKEN.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_ws_VALIDATE_TOKEN.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final Copy_of_ws_VALIDATE_TOKEN job;

		public RestServiceProviderImpl4TalendJob(Copy_of_ws_VALIDATE_TOKEN job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap,
				Copy_of_ws_VALIDATE_TOKEN job) {
		...
		public javax.ws.rs.core.Response header(
				...
				@javax.ws.rs.HeaderParam("correlationId") String correlationId
			...
			parameters_tRESTRequest_1.put("HEADER:correlationId:id_String", correlationId);
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(Copy_of_ws_VALIDATE_TOKEN job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = Copy_of_ws_VALIDATE_TOKEN.class.getClassLoader().getResourceAsStream(
					"salesforce/copy_of_ws_validate_token_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = Copy_of_ws_VALIDATE_TOKEN.class.getClassLoader()
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:b6ol5JjdyPnhIR2DGGITdTGT9kGy1gkn7/71dEja9K8=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:lyHlKy/T1RV2IVcd/h+vNTQMfHhQfm5TDwMwHeIIRhE=");
	...
	public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
		final static byte[] commonByteArrayLock_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN = new byte[0];
		static byte[] commonByteArray_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN.length == 0) {
						commonByteArray_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_Copy_of_ws_VALIDATE_TOKEN) {
...
// Start of branch "out"
						if (out != null) {
							...
							if (null == outputStream_tRESTResponse_1 && responseAlreadySent_tRESTResponse_1) {
								...
								restProviderResponse_tRESTResponse_1 = out.body;
				...
				try {
					...
					if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
						...
						if (matchedFlow_tRESTRequest_1.equals("header")) {
							...
							if (params_tRESTRequest_1.containsKey("HEADER:correlationId:id_String")) {

								header.correlationId = (String) params_tRESTRequest_1
										.get("HEADER:correlationId:id_String");
...
// Start of branch "header"
	...
	public static void main(String[] args) {
		final Copy_of_ws_VALIDATE_TOKEN Copy_of_ws_VALIDATE_TOKENClass = new Copy_of_ws_VALIDATE_TOKEN();

		int exitCode = Copy_of_ws_VALIDATE_TOKENClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Copy_of_ws_VALIDATE_TOKEN' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Copy_of_ws_VALIDATE_TOKEN' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_ws_VALIDATE_TOKEN.class.getClassLoader().getResourceAsStream(
					"salesforce/copy_of_ws_validate_token_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_ws_VALIDATE_TOKEN.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : Copy_of_ws_VALIDATE_TOKEN");
		}
...
/************************************************************************************************
 * 168084 characters generated by Talend Open Studio for ESB on the 2 août 2024
 * à 9:50:39 AM CET
 ************************************************************************************************/