		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:hqNm+iYFrKwDjYE2bw/u5EpmPZFcp6JRE/dyDS2kV1I=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:xUOS75niXtnQEQfJuIOKzMnh4uqQZIEe219zv9elBIQ=");
...
// Start of branch "row4"
						if (row4 != null) {
							...
							{ // start of Var scope
								...
								Var.var1 = "{ \"products\": { \"product\": [ { \"CD_PRODUIT\": \"" + row4.CD_PRODUIT
										+ "\", \"NOM_PRODUIT\": \"" + row4.NOM_PRODUIT + "\", \"PRIX_ACHAT_PRODUIT\": "
										+ row4.PRIX_ACHAT_PRODUIT + ", \"PRIX_VENTE_PRODUIT\": "
										+ row4.PRIX_VENTE_PRODUIT + " } ] } }";// ###############################
								// ###############################
								// # Output tables
...
/************************************************************************************************
 * 201666 characters generated by Talend Open Studio for ESB on the 5 août 2024
 * à 8:34:02 AM CET
 ************************************************************************************************/