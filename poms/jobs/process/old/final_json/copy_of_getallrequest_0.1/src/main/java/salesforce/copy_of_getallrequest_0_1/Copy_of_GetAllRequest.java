...
package salesforce.copy_of_getallrequest_0_1;
...
/**
 * Job: Copy_of_GetAllRequest Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Copy_of_GetAllRequest implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "Copy_of_GetAllRequest.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(Copy_of_GetAllRequest.class);
	...
	private final String jobName = "Copy_of_GetAllRequest";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					Copy_of_GetAllRequest.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Copy_of_GetAllRequest.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class RestServiceProviderImpl4TalendJob {
		...
		private final Copy_of_GetAllRequest job;

		public RestServiceProviderImpl4TalendJob(Copy_of_GetAllRequest job) {
			this.job = job;
		}

		private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap,
				Copy_of_GetAllRequest job) {
	...
	class Thread4RestServiceProviderEndpoint extends Thread {
		...
		public Thread4RestServiceProviderEndpoint(Copy_of_GetAllRequest job, String endpointUrl) {
			this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = Copy_of_GetAllRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/copy_of_getallrequest_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = Copy_of_GetAllRequest.class.getClassLoader()
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBConnection_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBConnection_1.append("PASS" + " = " + String.valueOf(
									"enc:routine.encryption.key.v1:Py4nVstWv5MGBC51ySdSEZPcY1fqk93Ak3O6klbMTzs=")
									.substring(0, 4) + "...");
							log4jParamters_tDBConnection_1.append(" | ");
				...
				final String decryptedPassword_tDBConnection_1 = routines.system.PasswordEncryptUtil
						.decryptPassword("enc:routine.encryption.key.v1:4QtJ89cUgawpsY0pAZmXqyYPEKt2Cma0kSRKuGH8x7g=");
	...
	public static class getAllStruct implements routines.system.IPersistableRow<getAllStruct> {
		final static byte[] commonByteArrayLock_SALESFORCE_Copy_of_GetAllRequest = new byte[0];
		static byte[] commonByteArray_SALESFORCE_Copy_of_GetAllRequest = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SALESFORCE_Copy_of_GetAllRequest.length) {
					if (length < 1024 && commonByteArray_SALESFORCE_Copy_of_GetAllRequest.length == 0) {
						commonByteArray_SALESFORCE_Copy_of_GetAllRequest = new byte[1024];
					} else {
						commonByteArray_SALESFORCE_Copy_of_GetAllRequest = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SALESFORCE_Copy_of_GetAllRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_Copy_of_GetAllRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_SALESFORCE_Copy_of_GetAllRequest, 0, length);
				strReturn = new String(commonByteArray_SALESFORCE_Copy_of_GetAllRequest, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_SALESFORCE_Copy_of_GetAllRequest) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "getAll");
				}
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						{ // start of Var scope
							...
							Var.var1 = "{ \"products\": { \"product\": [ { \"CD_PRODUIT\": \"" + row1.CD_PRODUIT
									+ "\", \"NOM_PRODUIT\": \"" + row1.NOM_PRODUIT + "\", \"PRIX_ACHAT_PRODUIT\": "
									+ row1.PRIX_ACHAT_PRODUIT + ", \"PRIX_VENTE_PRODUIT\": " + row1.PRIX_VENTE_PRODUIT
									+ " } ] } }";// ###############################
							// ###############################
							// # Output tables
...
// # Output table : 'getAll'
							...
							getAll_tmp.body = Var.var1;
							getAll = getAll_tmp;
							log.debug("tMap_1 - Outputting the record " + count_getAll_tMap_1
									+ " of the output table 'getAll'.");
...
// Start of branch "getAll"
						if (getAll != null) {
							...
							if (log.isTraceEnabled()) {
								log.trace("getAll - " + (getAll == null ? "" : getAll.toLogString()));
							}
							...
							if (null == outputStream_tRESTResponse_1 && responseAlreadySent_tRESTResponse_1) {
								...
								restProviderResponse_tRESTResponse_1 = getAll.body;
...
// ###############################      
				log.debug("tMap_1 - Written records count in the table 'getAll': " + count_getAll_tMap_1 + ".");
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "getAll");
				}
...
// Start of branch "header"
	...
	public static void main(String[] args) {
		final Copy_of_GetAllRequest Copy_of_GetAllRequestClass = new Copy_of_GetAllRequest();

		int exitCode = Copy_of_GetAllRequestClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'Copy_of_GetAllRequest' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		log.info("TalendJob: 'Copy_of_GetAllRequest' - Start.");
		...
		try {
			...
			java.io.InputStream inContext = Copy_of_GetAllRequest.class.getClassLoader()
					.getResourceAsStream("salesforce/copy_of_getallrequest_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Copy_of_GetAllRequest.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : Copy_of_GetAllRequest");
		}
...
/************************************************************************************************
 * 185333 characters generated by Talend Open Studio for ESB on the 5 août 2024
 * à 8:31:40 AM CET
 ************************************************************************************************/